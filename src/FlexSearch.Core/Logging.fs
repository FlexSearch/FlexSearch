...
module Logging =
    ...
    let logMethod keyword level ``exception`` (logValues : ILogValues) = 
        ...
        | MessageKeyword.Startup, MessageLevel.Verbose -> _logger.LogVerbose(7004, logValues, ``exception``)
        ...
        | MessageKeyword.Node, MessageLevel.Verbose -> _logger.LogVerbose(1004, logValues, ``exception``)
        ...
        | MessageKeyword.Index, MessageLevel.Verbose -> _logger.LogVerbose(2004, logValues, ``exception``)
        ...
        | MessageKeyword.Search, MessageLevel.Verbose -> _logger.LogVerbose(3004, logValues, ``exception``)
        ...
        | MessageKeyword.Document, MessageLevel.Verbose -> _logger.LogVerbose(4004, logValues, ``exception``)
        ...
        | MessageKeyword.Default, MessageLevel.Verbose -> _logger.LogVerbose(5004, logValues, ``exception``)
        ...
        | MessageKeyword.Plugin, MessageLevel.Verbose -> _logger.LogVerbose(5004, logValues, ``exception``)
