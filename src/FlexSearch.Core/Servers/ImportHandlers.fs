...
//                        else return! Choice2Of2(Errors.IMPORTER_DOES_NOT_SUPPORT_BULK_INDEXING)
//                    | true -> 
...
//                        else return! Choice2Of2(Errors.IMPORTER_DOES_NOT_SUPPORT_INCREMENTAL_INDEXING)
//                | _ -> return! Choice2Of2(Errors.IMPORTER_NOT_FOUND)
//            | None -> return! Choice2Of2(Errors.IMPORTER_NOT_FOUND)
//        }
//    
