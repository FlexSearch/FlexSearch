namespace FlexSearch.Specs.Helpers.SubSpec
{
    using System;
    ...
    internal static class Core
    {
        ...
        private class ActionTestCommand : TestCommand, ITestCommand
        {
            ...
            public override MethodResult Execute(object testClass)
            {
                ...
                {
                    return new FailedResult(this.testMethod, ex, this.DisplayName);
                }
            }
        }
        ...
        private class AssertExecutor
        {
            ...
            {
                foreach (var assertion in this._asserts)
                {
                    ...
                    Action test =
                        () =>
                        {
                            using (SpecificationPrimitiveExecutor.Execute(this._context))
                            {
                                if (this._do != null)
                                    SpecificationPrimitiveExecutor.Execute(this._do);
    ...
    public static class SpecificationExtensions
    {
        ...
        public static ISpecificationPrimitive Given(this string message, Action arrange)
        {
        ...
        public static ISpecificationPrimitive When(this string message, Action act)
        {
        ...
        public static ISpecificationPrimitive Then(this string message, Action assert)
        {
