namespace FlexSearch.Specs.Helpers.SubSpec
{
    ...
    internal abstract class SingleItemTheoryDataProvider : TheoryDataProvider
    {
        ...
        {
            return this.SingleItemDataSource().Select( x => new[] { x } );
        }
    ...
    internal class CompositeFixture : List<IDisposable>, IDisposable
    {
        ...
        internal class AggregateException : Exception
        {
            ...
            {
                this.InnerExceptions = new ReadOnlyCollection<Exception>( exceptions.ToList() );
            }
            ...
            public override string ToString()
            {
                ...
                return "AggregateException:" + splitter + string.Join( splitter, this.InnerExceptions.Select( _ => _.ToString() ).ToArray() );
            }
        }
    }
}
