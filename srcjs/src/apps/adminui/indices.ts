...
module flexportal {
    ...
    interface IIndicesScope extends ng.IScope, IMainScope {
    ...
    export class IndicesController {
        /* @ngInject */
        constructor($scope: IIndicesScope, indicesApi: API.Client.IndicesApi, documentsApi : API.Client.DocumentsApi, $q: any) {
        ...
        private GetIndicesData($scope: IIndicesScope, indicesApi : API.Client.IndicesApi, documentsApi : API.Client.DocumentsApi, $q: any) {
          ...
          return indicesApi.getAllIndicesHandled()
            ...
            .then(() => { $scope.indices.push($scope.indices[0]);
