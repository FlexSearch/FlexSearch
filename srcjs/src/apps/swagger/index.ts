...
module flexportal {
  ...
  // Services
    .service('commonApi', ["$http", "$mdBottomSheet", "$q", function($http, $mdBottomSheet, $q) { return new API.Client.CommonApi($http, null, apiHelpers.getBasePath(), $mdBottomSheet, $q, errorHandler); }])
